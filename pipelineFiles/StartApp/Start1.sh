...
docker exec wl bash -c "sh /u01/oracle/user_projects/domains/base_domain/deploysJenkins/App/birc/Shell/Start.sh ${urlwl} ${userwl} ${passwl} ${ArtifactName} ${domainWl} ${cluster} ${pathwl}";